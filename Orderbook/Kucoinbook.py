import requests
from Orderbook.Book import calculate_average1, calculate_average7
symbol = 'SHA'
const = 220
...
def calculate_average_price7(symbol, volume_in_coins, step_usdt):
    best_profit = 0
    best_ask_price = 0
    best_bid_price = 0
    best_ask_volume = 0
    ...
    best_ask_orders = 0
    best_bid_orders = 0
    step = step_usdt/float(ask_kucoin[0][0])
...
calculate_average_price7(symbol, volume_in_coins, step_usdt)'''
